...
function renderFinanceReport(data) {
  ...
  const groups = [
      ...
      items: [
        {
          label: "교재·인쇄물",
          filter: raw("준비비"),
          note: "- 강의 1~3권 교재, 회원수첩 인쇄비(40부)(행일미디어)\n- 입학식 현수막 제작(행일미디어)\n- E-브로슈어, 웹포스터 제작(레드우드코퍼레이션)",
        },
        {
          label: "수료식",
          filter: raw("인쇄비"),
          note: "- 수료식 가로현수막, 정방형현수막(4개)\n- 수료증 인쇄(30부)(1)",
        },
      ],
    },
    {
      ...
      items: [
        {
          label: "기념품",
          filter: raw("기념품"),
          note: "- 수료생 선물세트 60개\n※ 수료식 현수막·수료증 인쇄비, 다과비, 식비, 회의실 대관료는 인쇄비·다과및식비·교육장 항목에 각각 포함되어 있어 이 항목엔 기념품만 표시됨",
        },
      ],
    },
    {
      group: "교육장 및 회원수첩",
      items: [
        { label: "대관료", filter: raw("대관료"), note: "- 7개 회차 협회 회의실 예약(1)" },
        {
          label: "원우회 온라인 회원수첩",
    ...
    {
      group: "주차비",
      items: [{ label: "주차비", filter: raw("주차비"), note: "- 9회차 관리비 정산(1)" }],
    },
    {
      group: "기타(예비비)",
      items: [
  ...
  byId("finance-category-note").innerHTML = [
    "해당 항목 금액에는 11주차(수료식) 해당분이 포함되어 있음 — 수료식 운영비(현수막·수료증 인쇄비, 다과비, 식비, 회의실 대관료)는 별도 구분하지 않고 성격별 항목(인쇄비/다과및식비/교육장 및 회원수첩/주차비)에 합산 처리",
...
function renderBudgetCompare(data) {
  ...
  byId("budget-note").innerHTML = [
    ...
    "3) 예비비 중 회의실 임차료 550,000원은 9주차 회의실 예약 불가로 C동 지하1층 대회의실 사용(사용료+냉방료). 결의서상 보증금 20만원은 환급 예정으로 지출에서 제외",
    "4) 예비비 중 사회비 500,000원은 3기 장학생 황지영 불참으로 3기 원우(김은정)에게 수료식 사회 진행비를 추가 지급한 금액 — 예산 계획에 없던 항목",
    "※ 3기(2025년) 수익 18,317천원(31명 참여) 대비 4기 수익은 37,366천원(29명 참여)으로 약 2.0배 증가",
  ]
